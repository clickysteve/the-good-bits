...
export const PRESETS = [
  {
    ...
    settings: { style: "gentle", structure: 88, activity: 25, depth: 30, rollAmount: 15, pitchMode: "inkey", pitchAmount: 20 },
  },
  {
    key: "barswap",
    label: "Bar swap",
    blurb: "Bars and half-bars change places, repeat and answer each other. The phrase gets rewritten; the material doesn't.",
    settings: { style: "phrase", structure: 45, activity: 55, depth: 50, rollAmount: 20, pitchMode: "inkey", pitchAmount: 30 },
  },
  {
    key: "newgroove",
    label: "New groove",
    blurb: "Same bars, different rhythm. Beats and half-beats move around inside the structure.",
    settings: { style: "groove", structure: 70, activity: 60, depth: 50, rollAmount: 40, pitchMode: "inkey", pitchAmount: 25 },
  },
  {
    key: "fills",
    label: "Fills",
    blurb: "Leaves the loop alone and adds fills at the ends of bars and the end of the phrase.",
    settings: { style: "fill", structure: 85, activity: 30, depth: 65, rollAmount: 90, pitchMode: "inkey", pitchAmount: 25 },
  },
  {
    key: "melodic",
    label: "Melodic",
    blurb: "Finds a new tune in the one you already had - repeats transposed through the key in thirds and fifths.",
    settings: { style: "phrase", structure: 72, activity: 45, depth: 60, rollAmount: 25, pitchMode: "inkey", pitchAmount: 85 },
  },
  {
    key: "stutter",
    label: "Stutter",
    blurb: "The glitchy end. Micro-slices, rolls and rapid repeats, still hung off the beat grid.",
    settings: { style: "cutup", structure: 45, activity: 65, depth: 80, rollAmount: 65, pitchMode: "octaves", pitchAmount: 25 },
  },
  {
    key: "rebuild",
    label: "Rebuild",
    blurb: "Takes the phrase apart and puts it back in a different order. Same length, same material, new arrangement.",
    settings: { style: "reconstruct", structure: 30, activity: 70, depth: 65, rollAmount: 40, pitchMode: "inkey", pitchAmount: 45 },
  },
  {
    key: "destroy",
    label: "Destroy",
    blurb: "Everything, at every scale, as far as it goes. Most of these are rubbish. One of them won't be.",
    settings: { style: "wild", structure: 12, activity: 88, depth: 95, rollAmount: 80, pitchMode: "mixed", pitchAmount: 65 },
  },
];
